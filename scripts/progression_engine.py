...
CLASS_CATEGORIES: Dict[str, str] = {
    ...
    "cursor_rule":       "builder",
    "config_file":       "builder",   # 0 pts — boilerplate config, won't affect class
    "mtime_only":        "builder",   # 0 pts — mtime-touched but not in git
    # Video / design assets
    "video_rendered":    "builder",
    "thumbnail_rendered":"builder",
    "avatar_generated":  "builder",
...
def _grade_for_score(score: int) -> str:
    """Return letter grade for a given output score."""
...
def compute_total_xp(
    logs: List[Dict[str, Any]],
) -> Tuple[int, List[Dict[str, Any]]]:
    """Compute total XP as simple sum of daily output scores.

    Returns (total_xp, scoring_log).
    """
...
def build_profile(
    ...
    total_xp, scoring_log = compute_total_xp(logs)
