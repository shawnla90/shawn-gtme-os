---
title: Viral Hooks for Copy Content
description: A creative benchmark layer for scroll-stopping hooks — six hook styles with examples, platform considerations, and success benchmarks. Activates at the first 1-3 lines only.
source: skills/tier-1-voice-dna/viral-hooks.md
updated: 2026-07-02
order: 4
---
...
> **Layer type**: Creative benchmark. Complements voice and brand — does not override.
> **Inherits from**: `core-voice.md`
> **Activates at**: Hook level only (first 1–3 lines)
