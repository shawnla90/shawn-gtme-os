---
title: AI Content Pattern Detection — 29 Flags
description: 29 structural and formatting tells that trained readers spot as AI-generated content, organized in 5 categories with severity levels and the 3-flag accumulation rule.
source: skills/ai-pattern-detection/SKILL.md
updated: 2026-07-02
order: 2
---
...
> The critical patterns (1-10) are also embedded in `anti-slop-core.md` (this collection) for fast catches.
