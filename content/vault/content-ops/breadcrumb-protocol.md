---
title: Breadcrumb Protocol
description: Forward-referencing strategy for planting subtle hints about future projects in current content — creating a retroactive "the clues were there all along" effect at launch.
source: skills/tier-3-content-ops/breadcrumb-protocol.md
updated: 2026-07-02
order: 1
---
...
This is a strategy document, not a skill. Content creation skills reference this file when generating drafts and suggest one natural breadcrumb placement if an active breadcrumb is relevant to the topic.
...
If you run a multi-site network, keep a deliberate SEO topology (a keyword map file). When placing breadcrumbs, be aware of which site a post will live on and what keyword territory it serves:
...
Track your active breadcrumbs as entries like the two examples below — ideas from your idea bank that have breadcrumb notes and are worth hinting at in current content. (The real list stays internal until each project launches; these examples show the format.)

### Example 1: OS Thinking Beyond GTM → a lifestyle-OS direction (parked)
...
- Posts about the site network — the "first three" framing implies more
...
### Example 2: The Build Unlocks a New Layer → live streaming + community (parked)
