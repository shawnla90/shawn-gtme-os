---
title: "the AI is the teacher"
date: "2026-04-01"
excerpt: "I will never sell a course. the thing you're trying to learn can teach you itself. here's the system I built, the repos I open sourced, and the learning curve nobody skips."
category: "gtm-engineering"
featured: true
---

**tl;dr:** I open sourced eight repos including a 10-chapter GTM playbook. I will never sell a course. here's the full system, the learning curve from Cursor to API billing to Claude Code, and why CLIs beat MCPs for most GTM work. the [gtm-coding-agent](https://github.com/shawnla90/gtm-coding-agent) repo is the anti-course.
...
I've open sourced eight repos. all products of real builds. the newest one is the [gtm-coding-agent](https://github.com/shawnla90/gtm-coding-agent) repo on GitHub. 10 chapters covering everything from what a coding agent is, to context engineering, to turning your Mac into a GTM server with launchd and SQLite. interactive onboarding where you open it in Claude Code and type "help me set up" and it builds your workspace. templates, prompts, Python scripts. MIT licensed. free. I dropped it last week and I'm pushing new commits to it today.
...
right now I have four terminal sessions open. one is scraping 10,000 followers from a competitor's X account through Apify CLI. one is enriching a list through Apollo. one is pushing rows into Supabase. the fourth is writing this post through Claude Code. none of them are blocking each other. everything is happening in the background on a single Mac Mini.
...
**related posts:** [6 weeks of building with Claude Code](https://shawnos.ai/blog/6-weeks-of-building-with-claude-code) | [Google Workspace CLI](https://shawnos.ai/blog/google-workspace-cli)

the gtm-coding-agent repo, all scripts, and chapter links are on [GitHub](https://github.com/shawnla90/gtm-coding-agent).
