...
*None yet — first extraction sprint pending.*

## Ready for Extraction

| # | Playbook | Source | Priority | Destination |
|---|----------|--------|----------|-------------|
| 1 | 3-Variable Personalization Model | `docs/HOW-TO-ICEBREAKER-PAIN-POINT-PROMPTS.md` | P1 | GTMLS terms + How-To |
| 2 | Exa SDK: Icebreaker Search | `scripts/exa_icebreaker_enrichment.py` | P1 | GTMLS "Exa" + tutorial |
...
*Scanned but not yet prioritized. Run extraction prompt to refresh.*
