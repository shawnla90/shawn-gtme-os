...
export const metadata: Metadata = {
  title: 'System Vitals',
  description:
    'Live system scan of the GTM OS website ecosystem. Code depth, technical features, and the Nio website guardian.',
  alternates: { canonical: 'https://thegtmos.ai/vitals' },
  openGraph: {
    title: 'System Vitals | thegtmos.ai',
    description:
      'Live system scan of the GTM OS website ecosystem.',
    url: 'https://thegtmos.ai/vitals',
  },
  twitter: {
    title: 'System Vitals | thegtmos.ai',
    description:
