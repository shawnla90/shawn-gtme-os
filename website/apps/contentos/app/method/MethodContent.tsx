    ...
    <>
      ...
      <section
        ...
        style={{
          ...
          alignItems: 'center',
          background:
            'radial-gradient(ellipse 800px 600px at 50% 30%, rgba(155, 114, 207, 0.15), transparent 60%), var(--canvas)',
          textAlign: 'center',
          padding: '0 24px',
          position: 'relative',
        }}
      ...
      <ScrollRevealSection
        ...
        style={{ borderTop: '3px solid #9B72CF' }}
      >
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <MotionReveal variant="fadeUp">
            <div
            ...
            >
              {platformGrid.map((p) => (
                <StaggerItem key={p.name}>
                  <div style={{ ...tierCard, borderColor: 'rgba(155, 114, 207, 0.15)', height: '100%' }}>
                    <div style={{ fontSize: '15px', fontWeight: 700, color: '#9B72CF', marginBottom: 8 }}>
                      {p.name}
                    </div>
          ...
          <MotionReveal variant="fadeUp" delay={0.3}>
            <div
              style={{
                padding: '14px 20px',
                borderLeft: '3px solid #9B72CF',
                background: 'rgba(155, 114, 207, 0.05)',
                borderRadius: '0 6px 6px 0',
              }}
            >
              <p style={{ fontSize: '14px', fontWeight: 600, color: '#9B72CF', margin: 0, fontStyle: 'italic' }}>
      ...
      <ScrollRevealSection background="var(--canvas-subtle)">
        ...
        <MotionReveal variant="fadeIn" delay={0.3}>
          ...
          >
            ...
            <span style={{ fontSize: '15px', fontWeight: 700, color: '#9B72CF' }}>Playbooks</span>
            <span style={{ color: 'var(--text-muted)', fontSize: '18px' }}>&rarr;</span>
