...
const tools = [
  {
    name: 'Next.js',
    why: 'The framework that makes your site load in under 1 second.',
    Icon: FrameworkIcon,
  },
  {
    name: 'Vercel',
    why: 'Delivers your site from the closest server to every visitor.',
    Icon: ServerIcon,
  },
  {
    name: 'Cloudflare',
    why: 'Protects your site from attacks and makes it even faster.',
    Icon: ShieldIcon,
  },
  {
    name: 'PostHog',
  ...
  {
    name: 'GitHub',
    why: 'Every change to your site is tracked and reversible.',
    Icon: GitIcon,
  },
]

export function TechStackProof() {
  return (
    <div>
      <div
