    ...
    <>
      ...
      <div style={pageWrap}>
        ...
        {relatedEntries.length > 0 && (
          <>
            <hr style={divider} />
            <div style={relatedLabel}>{t('entry.relatedLabel')}</div>
            <div style={relatedWrap}>
        ...
        <div style={navRow}>
          <Link href="/context-wiki" style={navLink}>
            &larr; {t('entry.navBackToWiki')}
          </Link>
          <Link href="/knowledge" style={navLink}>
            {t('entry.navToKnowledge')} &rarr;
          </Link>
        </div>
      </div>
    </>
