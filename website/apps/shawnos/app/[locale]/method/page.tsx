...
const recursiveExamples: { label: string; desc: string }[] = [
  ...
  },
  {
    ...
    desc: 'a launch plan reached version three before shipping. each rewrite didn\'t start from scratch. it started from what the previous attempt revealed. the failure was the input.',
  },
  {
  ...
  return (
    <>
      ...
      <ScrollRevealSection background="var(--canvas-subtle)">
        <div style={section}>
          <SectionHeadline subtitle={t('states.sectionSubtitle')}>{t('states.sectionTitle')}</SectionHeadline>
      ...
      <ScrollRevealSection background="var(--canvas)">
        <div style={section}>
          <SectionHeadline subtitle={t('recursive.sectionSubtitle')}>{t('recursive.sectionTitle')}</SectionHeadline>
          ...
          <p style={paragraph}>
            this isn&apos;t CS recursion. it&apos;s system-level
            self-reference. the skill-play command was run on itself for its
            first execution. the post about the command that creates posts about
            skills was written by running that command on itself. recursion
            isn&apos;t a trick. it&apos;s a design constraint that forces
            generality.
          </p>

          <p style={{ ...mutedText, marginBottom: '20px' }}>
            when your documentation tool has to document itself, you&apos;re
            forced to make it general enough to document anything.
          </p>
      ...
      <ScrollRevealSection background="var(--canvas-subtle)">
        <div style={section}>
          <SectionHeadline>{t('antiPatterns.sectionTitle')}</SectionHeadline>
      ...
      <ScrollRevealSection background="var(--canvas)">
        <div style={section}>
          <SectionHeadline>{t('contrasts.sectionTitle')}</SectionHeadline>
      ...
      <ScrollRevealSection background="var(--canvas-subtle)">
        <div style={section}>
          <SectionHeadline>{t('paradox.sectionTitle')}</SectionHeadline>
      ...
      <ScrollRevealSection background="var(--canvas-subtle)">
        <div style={section}>
          <SectionHeadline>{t('seeItRunning.sectionTitle')}</SectionHeadline>
            ...
            {[
              {
                ...
                label: t('seeItRunning.links.fieldGuide.label'),
                desc: t('seeItRunning.links.fieldGuide.desc'),
              },
              {
                href: '/about/arc',
                label: t('seeItRunning.links.arc.label'),
                desc: t('seeItRunning.links.arc.desc'),
              },
              {
                href: '/log',
                label: t('seeItRunning.links.log.label'),
                desc: t('seeItRunning.links.log.desc'),
              },
              {
                href: '/blog',
                label: t('seeItRunning.links.blog.label'),
                desc: t('seeItRunning.links.blog.desc'),
              },
              {
                href: '/api',
                label: t('seeItRunning.links.api.label'),
                desc: t('seeItRunning.links.api.desc'),
              },
            ].map((link) => (
              <Link
                key={link.href}
