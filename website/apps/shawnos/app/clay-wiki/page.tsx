...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `/og?title=${encodeURIComponent('Clay Wiki')}&subtitle=${encodeURIComponent("The Practitioner's Guide")}`,
        width: 1200,
        height: 630,
      },
    ],
  ...
  twitter: {
    ...
    description:
      'Enrichment patterns, scoring systems, Claygent prompts, formulas, and real-world plays from a certified Clay practitioner.',
    images: [
      `/og?title=${encodeURIComponent('Clay Wiki')}&subtitle=${encodeURIComponent("The Practitioner's Guide")}`,
    ],
  },
}
    ...
    <>
      ...
      <div style={pageWrap}>
        ...
        <div style={navRow}>
          ...
          <Link href="/knowledge/gtm" style={navLink}>
            gtm terms &rarr;
          </Link>
        </div>
      </div>
