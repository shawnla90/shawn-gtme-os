  ...
  return (
    <>
      ...
      {bootPhase !== 'hidden' && (
        ...
        >
          ...
          <div className="dna-boot-content">
            ...
            <div className="dna-boot-label">DNA LAB v1.0</div>
            {!audioUnlocked && <div className="dna-boot-tap">tap to start</div>}
          </div>
        </div>
      )}
      ...
      <div className="dna-page" style={{ opacity: bootPhase === 'hidden' ? 1 : 0 }}>
        ...
        <h1 className="dna-title">Nio DNA Lab</h1>
              ...
              >
                ...
                <div className="dna-roadmap-content">
                  <div className="dna-roadmap-name">
                    {tier.name}
                    {tier.status === 'active' && <span className="dna-roadmap-current">&larr; current</span>}
                  </div>
          ...
          <TerminalChrome title="~/costs --breakdown">
            <div className="dna-cost-grid">
              <div className="dna-cost-row">
                <span className="dna-cost-label">Claude Max</span>
              ...
              <div className="dna-cost-row">
                <span className="dna-cost-label">API spend</span>
                <div className="dna-cost-bar-track">
                  <div
                    className="dna-cost-bar-fill"
                    style={{
              ...
              <div className="dna-cost-total">
                Total: <span style={{ color: BLADE_COLOR }}>${maxCount + apiCount}/mo</span>
              </div>
            </div>
            ...
            <div className="dna-cost-daily">
              ...
              <div className="dna-cost-daily-grid">
                <div className="dna-cost-daily-item">
                  ...
                  <span className="dna-cost-daily-lbl">messages</span>
                </div>
                <div className="dna-cost-daily-item">
                  <span className="dna-cost-daily-val">${(costCount / 100).toFixed(2)}</span>
                  <span className="dna-cost-daily-lbl">API cost</span>
                </div>
                <div className="dna-cost-daily-item">
                  <span className="dna-cost-daily-val">$10</span>
                  <span className="dna-cost-daily-lbl">daily cap</span>
                </div>
                <div className="dna-cost-daily-item">
                  <span className="dna-cost-daily-val">45%</span>
                  <span className="dna-cost-daily-lbl">utilization</span>
                </div>
              </div>
            </div>
          </TerminalChrome>
